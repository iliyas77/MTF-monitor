...
(function (global) {
    ...
    function renderTradeDetailsList(t) {
        ...
        const rows = [
            { label: 'Buy', amount: tx.buyPrice, tone: 'secondary', decimals: true, labelClass: 'buy-price-label' },
        ...
        return `<div class="trade-detail-list">${rows.map(renderTradeDetailRow).join('')}</div>`;
    }
