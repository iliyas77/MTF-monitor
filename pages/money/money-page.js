    ...
    function renderMoney() {
        ...
        if (accountList) {
            ...
            if (visibleAccounts.length === 0) {
                accountList.innerHTML = `<div class="text-center text-muted py-5">${global.MTFComponents.renderIcon('fa-university', { size: 'lg', className: 'mb-3 opacity-50' })}<h6>No accounts yet</h6><p class="small text-muted mb-0">Go to <span class="fw-semibold">Settings</span> and tap <span class="fw-semibold">Add Account</span> to create your first trading account.</p></div>`;
            } else {
