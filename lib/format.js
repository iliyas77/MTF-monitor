...
(function (global) {
    ...
    const AMOUNT_SIZES = {
        xs: { shell: 'px-2 py-1 rounded', value: 'small fw-normal', words: 'small mt-1' },
        sm: { shell: 'px-2 py-1 rounded', value: 'small fw-normal', words: 'small mt-1' },
        md: { shell: 'px-2 py-1 rounded', value: 'fw-normal', words: 'small mt-1' },
    ...
    function toggleMoneyAccountExpand(btn) {
        ...
        if (details) details.classList.toggle('d-none', !next);
    }
    ...
    function toggleTradeDateGroupExpand(btn) {
        ...
        if (list) list.classList.toggle('d-none', !next);
    }
    ...
    const DEFAULT_CALC_SELL_PCTS = [1, 1.5, 2, 3, 5];
