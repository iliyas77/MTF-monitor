/**
 * DB call log — count Firestore reads/writes locally by day.
 * Live counters stay in localStorage; the synced `dbCallLog` property
 * is updated only when the user manually flushes (to avoid extra DB cost).
 */
(function (global) {
    'use strict';
