...
1. Whenever the user requests a new ticket (e.g. by mentioning this TICKETS.md file), the AI MUST automatically write the ticket into `ticket.txt` using the `### [NEW]` block format.
