...
(function (global) {
    ...
    function setTxModalMode(isEdit = false) {
        ...
        if (viewBtn) viewBtn.classList.toggle('hidden', !isEdit);
    }
    ...
    function syncTxSellPriceField() {
        ...
        if (reqMark) reqMark.classList.toggle('hidden', isOpen);
        if (hint) hint.classList.toggle('hidden', !isOpen);
    }
    ...
    function syncTxModalStatusField() {
        ...
        if (row) row.classList.toggle('hidden', hideStatus);
    }
